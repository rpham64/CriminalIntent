...
public class ZoomActivity extends FragmentActivity {
    ...
    // "Short" animation time duration, in milliseconds
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Convert mPhotoFile path to resID
        final int resID = getResources().getIdentifier(mPhotoFile.getPath(), "drawable", getPackageName());

        // Create clicks on thumbnail view
        mPhotoView = findViewById(R.id.crime_photo);
        mPhotoView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomImageFromThumb(mPhotoView, resID);
            }
        });
    ...
    public void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        findViewById(R.id.view_camera_and_title_container)
